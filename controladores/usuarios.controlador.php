...
class ControladorUsuarios{
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])){
				...
				if($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["contraseña"] == $encriptar){
					...
					if($respuesta["estado"] == 1){
						...
						$_SESSION["id_area"] = $respuesta["id_area"];
	...
	=============================================*/
	static public function ctrMostrarUsuarioxId($item1, $valor1){

		$tabla= "usuario";
		
		$respuesta = ModeloUsuarios::MdlMostrarUsuarioxId($tabla, $item1, $valor1);	
	...
	/*=============================================
	MOSTRAR USUARIO - PARA LLENAR TABLA USAURIOS
	=============================================*/
