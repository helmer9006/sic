        ...
        foreach ($usuarios as $key => $value){
          ...
          echo ' <tr>
                  ...
                  if($value["foto_usuario"] != ""){
                    ...
                    echo '<td><img src="'.$value["foto_usuario"].'" class="img-thumbnail" width="40px"></td>';
                  ...
                  <td>
                    ...
                    <div class="btn-group">
                     ...
                     <button class="btn btn-danger btnEliminarUsuario" idUsuario="'.$value["id"].'" fotoUsuario="'.$value["foto_usuario"].'" usuario="'.$value["usuario"].'"><i class="fa fa-times"></i></button>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <select class="form-control input-lg" name="nuevoPerfil">
                  ...
                  <option value="Vendedor">Estandar</option>
             ...
             <!-- ENTRADA PARA SELECCIONAR SU AREA -->
            ...
            <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-addon"><i class="fa fa-users"></i></span>
                            ...
                            <select class="form-control input-lg" name="editarArea">
