...
<head>
  ...
  <!-- Idioima Español para DataPicker -->
  <script src="vistas/bower_components/bootstrap-datepicker/locales/bootstrap-datepicker.es.min.js" charset="UTF-8"></script>
  <!-- Moment para cambiar formato de fecha y mas -->   
   ...
   echo '<div class="wrapper">';
    ...
    if(isset($_GET["ruta"])){
      ...
      if($_GET["ruta"] == "inicio" ||
         ...
         $_GET["ruta"] == "marcas" ||
         $_GET["ruta"] == "areas" ||
         $_GET["ruta"] == "tipos-tickets" ||
         $_GET["ruta"] == "tipos-equipos" ||
         $_GET["ruta"] == "salir"){
...
<script src="vistas/js/dependencias.js"></script>
<script src="vistas/js/tipos-tickets.js"></script>
<script src="vistas/js/tipos-equipos.js"></script>
